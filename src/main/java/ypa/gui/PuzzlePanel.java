...
public class PuzzlePanel extends javax.swing.JPanel {
     ...
     */
    public void setPuzzle(final HPuzzle puzzle) {
        this.puzzle = puzzle;
        this.selected = null;
     ...
     */
    public void setSelected(final HCell cell) {
        this.selected = cell;
    }
     ...
     */
    public void setMarkedCells(final Collection<HCell> markedCells) {
        if (markedCells == null) {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int r = 0; r != puzzle.getRowCount(); ++r) {
            ...
            for (int c = 0; c != puzzle.getColumnCount(); ++c) {
                final int x = c * cellSize + offsetX;
                final HCell cell = puzzle.getCell(r, c);
     ...
     * @pre {@code evt != null}
     */
    public HCell mouseToCell(final MouseEvent evt) {
        if (puzzle == null) {
            return null;
        }
